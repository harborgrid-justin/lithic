...
export declare function getReferenceRange(
  loincCode: string,
  age: number,
  gender: "male" | "female",
): ReferenceRange | undefined;
export declare function isCritical(
  loincCode: string,
  value: number,
  age: number,
  gender: "male" | "female",
): boolean;
export declare function isAbnormal(
  loincCode: string,
  value: number,
  age: number,
  gender: "male" | "female",
): boolean;
export declare function getAbnormalityFlag(
  loincCode: string,
  value: number,
  age: number,
  gender: "male" | "female",
