...
exports.COMMON_PANELS = exports.LOINC_CODES = void 0;
exports.getLOINCCode = getLOINCCode;
exports.getLOINCCodesByCategory = getLOINCCodesByCategory;
exports.searchLOINCCodes = searchLOINCCodes;
exports.LOINC_CODES = {
    // CHEMISTRY
    '2345-7': {
        code: '2345-7',
...
exports.COMMON_PANELS = {
    CMP: {
        name: 'Comprehensive Metabolic Panel',
        code: '24323-8',
        tests: ['2345-7', '2160-0', '2951-2', '2823-3', '2075-0', '2028-9', '3094-0', '1742-6', '1920-8', '1975-2', '17861-6']
    },
    BMP: {
        name: 'Basic Metabolic Panel',
        code: '24324-6',
        tests: ['2345-7', '2160-0', '2951-2', '2823-3', '2075-0', '2028-9', '3094-0', '17861-6']
    },
    CBC: {
        name: 'Complete Blood Count',
        code: '58410-2',
        tests: ['6690-2', '789-8', '718-7', '4544-3', '787-2', '785-6', '786-4', '777-3']
    },
    LIPID: {
        name: 'Lipid Panel',
        code: '24331-1',
...
function getLOINCCode(code) {
    return exports.LOINC_CODES[code];
}
function getLOINCCodesByCategory(category) {
    return Object.values(exports.LOINC_CODES).filter(loinc => loinc.category === category);
}
function searchLOINCCodes(query) {
    const lowerQuery = query.toLowerCase();
    return Object.values(exports.LOINC_CODES).filter(loinc => loinc.displayName.toLowerCase().includes(lowerQuery) ||
        loinc.commonName?.toLowerCase().includes(lowerQuery) ||
        loinc.component.toLowerCase().includes(lowerQuery) ||
        loinc.code.includes(query));
}
//# sourceMappingURL=loinc-codes.js.map