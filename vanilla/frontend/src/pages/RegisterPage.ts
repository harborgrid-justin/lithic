  ...
  private createCardContent(): HTMLElement {
    ...
    const fields: FormField[] = [
      ...
      },
      {
        ...
        validation: [
          validationRules.phoneNumber('Invalid phone number'),
        ],
      },
      {
        name: 'password',
        ...
        validation: [
          ...
          validationRules.minLength(12, 'Password must be at least 12 characters'),
      ...
      },
      {
        ...
        validation: [
          validationRules.required('Please select a role'),
        ],
      },
    ];
