...
export class AuditLog {
  ...
  private applyFilters(): void {
    const action = (
      document.getElementById("filter-action") as HTMLSelectElement
    )?.value;
    const severity = (
      document.getElementById("filter-severity") as HTMLSelectElement
    )?.value;
    const phiOnly = (document.getElementById("filter-phi") as HTMLInputElement)
      ?.checked;
    const startDate = (
