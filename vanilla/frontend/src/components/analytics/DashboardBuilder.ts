...
export class DashboardBuilder {
  ...
  constructor(container: HTMLElement, onSave: (config: DashboardConfig) => void, initialConfig?: Partial<DashboardConfig>) {
  ...
  private render(): void {
    ...
    // Description
    form.appendChild(this.createField('textarea', 'description', 'Description'));

    // Category
    form.appendChild(this.createField('select', 'category', 'Category', true, [
    ...
    // Visibility
    form.appendChild(this.createField('select', 'visibility', 'Visibility', true, [
