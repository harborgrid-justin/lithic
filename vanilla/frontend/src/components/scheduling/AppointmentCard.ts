...
export class AppointmentCard {
  ...
  private renderActionButtons(): string {
    ...
    if (status === 'scheduled') {
      buttons.push('<button class="btn-small" data-action="confirm">Confirm</button>');
      buttons.push('<button class="btn-small" data-action="check-in">Check In</button>');
    } else if (status === 'confirmed') {
      buttons.push('<button class="btn-small" data-action="check-in">Check In</button>');
    } else if (status === 'checked-in') {
      buttons.push('<button class="btn-small" data-action="start">Start</button>');
    } else if (status === 'in-progress') {
      buttons.push('<button class="btn-small" data-action="complete">Complete</button>');
    }
