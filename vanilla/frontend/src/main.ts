...
class App {
  ...
  private setupRoutes() {
    ...
    this.router.register("/patients/:id", (params) =>
      this.renderPatientDetailPage(params.id),
    );
  ...
  private renderPatientsPage() {
    this.renderPage(
      "Patient Management",
      "<p>Patient Management - Agent 2</p>",
    );
  }
