...
class Router {
  ...
  private showDashboard(params?: any): void {
    ...
    if (container) {
      ...
      this.currentPage = new ClinicalDashboardPage(
        "clinical-dashboard",
  ...
  private showEncounterDetail(encounterId: string): void {
    ...
    if (container) {
      ...
      import("./pages/clinical/EncounterDetailPage").then((module) => {
        this.currentPage = new module.EncounterDetailPage(
          "encounter-detail",
          encounterId,
        );
        this.currentPage.init();
  ...
  private showProblems(params?: any): void {
    ...
    if (container) {
      ...
      import("./pages/clinical/ProblemsPage").then((module) => {
        this.currentPage = new module.ProblemsPage(
          "problems-page",
          params?.patientId || "",
        );
        this.currentPage.init();
  ...
  private showAllergies(params?: any): void {
    ...
    if (container) {
      ...
      import("./pages/clinical/AllergiesPage").then((module) => {
        this.currentPage = new module.AllergiesPage(
          "allergies-page",
          params?.patientId || "",
        );
        this.currentPage.init();
  ...
  private showMedications(params?: any): void {
    ...
    if (container) {
      ...
      import("./pages/clinical/MedicationsPage").then((module) => {
        this.currentPage = new module.MedicationsPage(
          "medications-page",
          params?.patientId || "",
        );
        this.currentPage.init();
