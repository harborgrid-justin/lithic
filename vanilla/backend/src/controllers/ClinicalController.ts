...
export class ClinicalController {
  ...
  async signNote(req: Request, res: Response): Promise<void> {
    try {
      ...
      res.status(500).json({ success: false, error: error instanceof Error ? error.message : 'Failed to sign note' });
    }
  }
  ...
  async addAddendum(req: Request, res: Response): Promise<void> {
    try {
      ...
      const note = await ClinicalService.addAddendum(noteId, addendumText, userId);
      if (!note) {
        res.status(404).json({ success: false, error: 'Note not found' });
        return;
      }
      ...
      res.status(500).json({ success: false, error: error instanceof Error ? error.message : 'Failed to add addendum' });
    }
  }
  ...
  async getProblemsByPatient(req: Request, res: Response): Promise<void> {
    try {
      ...
      const problems = await ClinicalService.getProblemsByPatient(patientId, activeOnly);
  ...
  async createAllergy(req: Request, res: Response): Promise<void> {
    try {
      ...
      res.status(500).json({ success: false, error: 'Failed to create allergy' });
    }
  }
  ...
  async getAllergiesByPatient(req: Request, res: Response): Promise<void> {
    try {
      ...
      const allergies = await ClinicalService.getAllergiesByPatient(patientId, activeOnly);
  ...
  async createMedication(req: Request, res: Response): Promise<void> {
    try {
      ...
      const medication = await ClinicalService.createMedication(medicationData, userId);
  ...
  async getMedicationsByPatient(req: Request, res: Response): Promise<void> {
    try {
      const { patientId } = req.params;
      const activeOnly = req.query.activeOnly !== 'false';
      const medications = await ClinicalService.getMedicationsByPatient(patientId, activeOnly);
  ...
  async updateMedication(req: Request, res: Response): Promise<void> {
    try {
      ...
      const medication = await ClinicalService.updateMedication(medicationId, updates);
      if (!medication) {
  ...
  async signOrder(req: Request, res: Response): Promise<void> {
    try {
      ...
      res.status(500).json({ success: false, error: error instanceof Error ? error.message : 'Failed to sign order' });
    }
  }
  ...
  async searchICD10(req: Request, res: Response): Promise<void> {
    try {
      ...
      res.status(500).json({ success: false, error: 'Failed to search ICD-10 codes' });
    }
  }
  ...
  async searchCPT(req: Request, res: Response): Promise<void> {
    try {
      ...
      res.status(500).json({ success: false, error: 'Failed to search CPT codes' });
    }
  }
  ...
  async getICD10ByCode(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (!icd10) {
        res.status(404).json({ success: false, error: 'ICD-10 code not found' });
        return;
      }
      ...
      res.status(500).json({ success: false, error: 'Failed to fetch ICD-10 code' });
    }
  }
  ...
  async getCPTByCode(req: Request, res: Response): Promise<void> {
    try {
      ...
      res.status(500).json({ success: false, error: 'Failed to fetch CPT code' });
    }
  }
