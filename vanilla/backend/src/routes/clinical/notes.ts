...
router.get("/encounter/:encounterId", (req, res) =>
  ClinicalController.getNotesByEncounter(req, res),
);

// Get notes by patient
router.get("/patient/:patientId", (req, res) =>
  ClinicalController.getNotesByPatient(req, res),
);
...
// Sign note
router.post("/:noteId/sign", (req, res) =>
  ClinicalController.signNote(req, res),
);

// Add addendum to note
router.post("/:noteId/addendum", (req, res) =>
  ClinicalController.addAddendum(req, res),
);

// Get templates
router.get("/templates/list", (req, res) =>
  ClinicalController.getTemplates(req, res),
);

// Get template by ID
router.get("/templates/:templateId", (req, res) =>
  ClinicalController.getTemplateById(req, res),
);
