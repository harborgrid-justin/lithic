...
router.get("/encounter/:encounterId", (req, res) =>
  ClinicalController.getOrdersByEncounter(req, res),
);

// Get orders by patient
router.get("/patient/:patientId", (req, res) =>
  ClinicalController.getOrdersByPatient(req, res),
);
...
router.post("/:orderId/sign", (req, res) =>
  ClinicalController.signOrder(req, res),
);
...
// Get CPT by code
router.get("/cpt/:code", (req, res) =>
  ClinicalController.getCPTByCode(req, res),
);
