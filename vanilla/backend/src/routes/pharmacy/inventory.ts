...
router.get(
  "/:id",
  pharmacyController.getInventoryItem.bind(pharmacyController),
);
...
router.post(
  "/",
  pharmacyController.createInventoryItem.bind(pharmacyController),
);
...
router.patch(
  "/:id/quantity",
  pharmacyController.updateInventoryQuantity.bind(pharmacyController),
);
