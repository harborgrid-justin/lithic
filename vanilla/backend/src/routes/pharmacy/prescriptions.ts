 ...
 * @access  Private
 */
router.post('/', pharmacyController.createPrescription.bind(pharmacyController));
 ...
 * @access  Private
 */
router.patch('/:id/status', pharmacyController.updatePrescriptionStatus.bind(pharmacyController));
