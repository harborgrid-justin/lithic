...
export class ClinicalService {
  ...
  async getProblemsByPatient(
    ...
    return problems.sort(
      (a, b) => b.onsetDate.getTime() - a.onsetDate.getTime(),
    );
  }
