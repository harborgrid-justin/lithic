...
interface TemplateSelectorProps {
  ...
  noteType?: 'soap' | 'progress' | 'admission' | 'discharge' | 'procedure' | 'consultation'
}
...
const mockTemplates: NoteTemplate[] = [
  {
    ...
    type: 'soap',
    content: '',
    subjectiveTemplate: 'Chief Complaint:\n\nHistory of Present Illness:\n\nReview of Systems:',
...
export function TemplateSelector({ onSelect, noteType }: TemplateSelectorProps) {
