...
import type { ScheduleConflict, TimeSlot, Appointment } from '@/types/scheduling';
      ...
      <Card className="border-orange-200 bg-orange-50">
        <CardHeader>
          <div className="flex items-center space-x-2">
            ...
            <CardTitle className="text-orange-900">Schedule Conflict Detected</CardTitle>
          </div>
        </CardHeader>
        <CardContent>
          ...
          {conflict.conflictingAppointments && conflict.conflictingAppointments.length > 0 && (
            <div className="mt-4 pt-4 border-t border-orange-200">
              <h4 className="font-medium text-orange-900 mb-2">Conflicting Appointments:</h4>
