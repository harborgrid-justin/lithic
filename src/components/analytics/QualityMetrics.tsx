...
export function QualityMetrics({ filters, className = '' }: QualityMetricsProps) {
  ...
  const groupedMeasures = cmsMeasures.reduce((acc, measure) => {
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      {/* Key Metrics */}
      <div>
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Key Quality Indicators</h2>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-lg font-semibold text-gray-900">CMS Core Measures</h2>
        </div>
                    ...
                    <div className="w-48 ml-4">
                      <div className="relative h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{ width: `${Math.min(100, (measure.score / measure.target) * 100)}%` }}
                        />
                        {/* Target marker */}
                        <div
                          className="absolute top-0 w-0.5 h-full bg-gray-900"
                          style={{ left: `${(measure.benchmark / measure.target) * 100}%` }}
                        />
                      </div>
