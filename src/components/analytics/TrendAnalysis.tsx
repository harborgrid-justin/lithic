...
import { TimeSeriesData, FilterConfig, analyticsService } from '@/services/analytics.service';
  ...
  return (
    <div className={`bg-white rounded-lg border border-gray-200 ${className}`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              onChange={(e) => setSelectedGranularity(e.target.value as typeof granularity)}
      ...
      <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
        <h4 className="text-sm font-semibold text-gray-900 mb-3">Statistical Insights</h4>
