...
export class LaboratoryService {
  ...
  static async createOrder(
    order: Omit<LabOrder, "id" | "orderNumber" | "createdAt" | "updatedAt">,
  ): Promise<LabOrder> {
  ...
  static async createResult(
    result: Omit<LabResult, "id" | "createdAt" | "updatedAt">,
  ): Promise<LabResult> {
  ...
  static async createPanel(
    panel: Omit<LabPanel, "id" | "createdAt" | "updatedAt">,
  ): Promise<LabPanel> {
    const response = await fetch(`${this.baseUrl}/panels`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
