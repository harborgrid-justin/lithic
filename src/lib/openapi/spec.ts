...
export const openApiSpec = {
  ...
  info: {
    ...
    version: '1.0.0',
    description: 'Enterprise Healthcare SaaS Platform - Complete API Documentation',
    contact: {
      name: 'Lithic Support',
  ...
  tags: [
    ...
    { name: 'Appointments', description: 'Scheduling and appointment management' },
