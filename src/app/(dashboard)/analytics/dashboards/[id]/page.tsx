...
import { Dashboard, Widget, analyticsService } from '@/services/analytics.service';
  ...
  const loadDashboard = async () => {
    ...
    try {
      ...
      const dataPromises = data.widgets.map(async (widget) => {
        const widgetDataResult = await analyticsService.getWidgetData(widget, data.filters);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-6">The dashboard you&apos;re looking for doesn&apos;t exist.</p>
          <Link
