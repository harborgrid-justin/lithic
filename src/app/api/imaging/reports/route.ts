...
let reports: any[] = [
  {
    ...
    technique: 'Helical CT of the chest was performed following administration of intravenous contrast. Axial images were obtained from the thoracic inlet through the upper abdomen. Coronal and sagittal reformations were generated.',
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (radiologist) {
      filteredReports = filteredReports.filter(r => r.radiologist === radiologist);
    }
