...
const mockDicomTags = [
  { tag: '0008,0005', vr: 'CS', value: 'ISO_IR 100', name: 'SpecificCharacterSet' },
  { tag: '0008,0008', vr: 'CS', value: ['ORIGINAL', 'PRIMARY', 'AXIAL'], name: 'ImageType' },
  { tag: '0008,0016', vr: 'UI', value: '1.2.840.10008.5.1.4.1.1.2', name: 'SOPClassUID' },
  { tag: '0008,0018', vr: 'UI', value: '1.2.840.113619.2.55.3.2831868566.123.1640000001.1.1.1', name: 'SOPInstanceUID' },
  ...
  { tag: '0008,0050', vr: 'SH', value: 'ACC-2026-001', name: 'AccessionNumber' },
  { tag: '0008,0060', vr: 'CS', value: 'CT', name: 'Modality' },
  { tag: '0008,0070', vr: 'LO', value: 'GE MEDICAL SYSTEMS', name: 'Manufacturer' },
  { tag: '0008,0090', vr: 'PN', value: 'Dr. Brown', name: 'ReferringPhysicianName' },
  { tag: '0008,103E', vr: 'LO', value: 'Axial Contrast', name: 'SeriesDescription' },
  ...
  { tag: '0020,000D', vr: 'UI', value: '1.2.840.113619.2.55.3.2831868566.123.1640000001.1', name: 'StudyInstanceUID' },
  { tag: '0020,000E', vr: 'UI', value: '1.2.840.113619.2.55.3.2831868566.123.1640000001.1.3', name: 'SeriesInstanceUID' },
  { tag: '0020,0011', vr: 'IS', value: '3', name: 'SeriesNumber' },
  { tag: '0020,0013', vr: 'IS', value: '1', name: 'InstanceNumber' },
  { tag: '0020,0032', vr: 'DS', value: [-125.0, -125.0, 0.0], name: 'ImagePositionPatient' },
  { tag: '0020,0037', vr: 'DS', value: [1, 0, 0, 0, 1, 0], name: 'ImageOrientationPatient' },
  { tag: '0028,0002', vr: 'US', value: 1, name: 'SamplesPerPixel' },
  { tag: '0028,0004', vr: 'CS', value: 'MONOCHROME2', name: 'PhotometricInterpretation' },
  { tag: '0028,0010', vr: 'US', value: 512, name: 'Rows' },
  { tag: '0028,0011', vr: 'US', value: 512, name: 'Columns' },
  { tag: '0028,0030', vr: 'DS', value: [0.488281, 0.488281], name: 'PixelSpacing' },
