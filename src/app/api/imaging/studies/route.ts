...
let studies: any[] = [
  {
    ...
    seriesList: [
      {
        id: 'SER-001',
        seriesInstanceUID: '1.2.840.113619.2.55.3.2831868566.123.1640000001.1.1',
        seriesNumber: 1,
      ...
      {
        id: 'SER-002',
        seriesInstanceUID: '1.2.840.113619.2.55.3.2831868566.123.1640000001.1.2',
        seriesNumber: 2,
      ...
      {
        id: 'SER-003',
        seriesInstanceUID: '1.2.840.113619.2.55.3.2831868566.123.1640000001.1.3',
        seriesNumber: 3,
  ...
  },
  {
    ...
    seriesList: [
      {
        id: 'SER-004',
        seriesInstanceUID: '1.2.840.113619.2.55.3.2831868566.456.1640000002.1.1',
        seriesNumber: 1,
      ...
      {
        id: 'SER-005',
        seriesInstanceUID: '1.2.840.113619.2.55.3.2831868566.456.1640000002.1.2',
        seriesNumber: 2,
      ...
      {
        id: 'SER-006',
        seriesInstanceUID: '1.2.840.113619.2.55.3.2831868566.456.1640000002.1.3',
        seriesNumber: 3,
      ...
      {
        id: 'SER-007',
        seriesInstanceUID: '1.2.840.113619.2.55.3.2831868566.456.1640000002.1.4',
        seriesNumber: 4,
      ...
      {
        id: 'SER-008',
        seriesInstanceUID: '1.2.840.113619.2.55.3.2831868566.456.1640000002.1.5',
        seriesNumber: 5,
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (accessionNumber) {
      filteredStudies = filteredStudies.filter(s => s.accessionNumber === accessionNumber);
    }
    ...
    if (startDate && endDate) {
      filteredStudies = filteredStudies.filter(s => {
        ...
        return studyDate >= new Date(startDate) && studyDate <= new Date(endDate);
      });
    }
