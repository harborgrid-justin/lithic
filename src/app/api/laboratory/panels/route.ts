...
let panels: LabPanel[] = [
  {
    ...
    description:
      "Comprehensive evaluation of blood cells including WBC, RBC, hemoglobin, hematocrit, and platelets",
  ...
  },
  {
    ...
    description:
      "Panel of blood tests measuring glucose, electrolytes, and kidney function",
    tests: [
      "2345-7",
      "3094-0",
      "2160-0",
